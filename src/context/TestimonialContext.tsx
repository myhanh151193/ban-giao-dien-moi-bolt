...
const initialTestimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    content: "Template e-commerce của TemplateHub giúp startup của tôi tiết kiệm 6 tháng phát triển. Code sạch, tích hợp thanh toán ��ầy đủ, và responsive hoàn hảo. Đội ngũ hỗ trợ rất chuyên nghiệp.",
  ...
  },
  {
    ...
    rating: 5,
    content: "Blog template có giao diện đẹp, load nhanh và SEO-friendly. Traffic blog của tôi tăng 200% sau 3 tháng sử dụng. H��� trợ đa ngôn ngữ và tích hợp social media tốt.",
